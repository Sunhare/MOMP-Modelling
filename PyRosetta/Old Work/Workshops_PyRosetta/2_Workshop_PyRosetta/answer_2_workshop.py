...
pose = pose_from_file("1YY8.clean.pdb")
...
# get_secstruct(pose) #NO

#This is the right answer
#Your documentation is bad and you should feel bad
set_ss_from_phipsi(pose) 
pose.secstruct()

pmm = PyMOLMover()
pmm.apply(pose) #PYMOLMOVER
pmm.keep_history(True) #PYMOLMOVER
# Protein Geometry
print( pose.phi(5) )
print( pose.psi(5) )
print( pose.chi(1, 5) )
